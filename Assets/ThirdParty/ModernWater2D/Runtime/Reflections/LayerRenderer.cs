...
namespace Water2D
{
    ...
    public class LayerRenderer
    {
        ...
        [HideInInspector][SerializeField] private int reflectionLayerIdx = -1;

        private bool _run;
        [HideInInspector][SerializeField] internal bool copyMainBackground = false;
        [HideInInspector][SerializeField] private float lastOrtographicSize = 0f;
        [HideInInspector][SerializeField] private float lastAspectRatio = 0f;
