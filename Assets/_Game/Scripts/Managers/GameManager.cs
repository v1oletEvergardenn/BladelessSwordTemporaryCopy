...
public class GameManager : MonoBehaviour
{
    ...
    [HideProperty] public PlayerControl player_controller;
    ...
    public void CheckIfStartFromMainMenu()
    {
        ...
        if (!isMenuLoaded)
        {
            ...
            {
                CreatePlayerReference(PlayerControl.instance.gameObject);
            }
            else
            {
                CreateNewPlayer();
    ...
    public void CreatePlayerReference(GameObject _player)
    {
        ...
        player_controller = _player.GetComponentInChildren<PlayerControl>();
